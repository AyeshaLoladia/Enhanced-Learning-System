<nav x-data="{ open: false }" class="top-0 w-full z-10" style="background-color: #a02929">
    ...
    <div class="w-full px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-drop_down align="right" width="48">
                    <x-slot name="trigger">
                ...
                focus:outline-none transition ease-in-out duration-150" style="float: right;">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-gray-200 hover:text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1 border-t border-gray-200">
            ...
            @role('admin')
            <x-responsive-nav-link :href="route('add-faculty')" :active="request()->routeIs('add-faculty')">
                {{ __('Add Faculty') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('courses.create')" :active="request()->routeIs('courses.create')">
                {{ __('Create Course') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('manage-courses')" :active="request()->routeIs('manage-courses')">
                {{ __('Manage Courses') }}
            </x-responsive-nav-link>
            @endrole
            @role('faculty')
            ...
            <x-responsive-nav-link :href="route('enrolled-courses')" :active="request()->routeIs('enrolled-courses')">
                {{ __('Enrolled Courses') }}
            </x-responsive-nav-link>
            @endrole
        </div>
